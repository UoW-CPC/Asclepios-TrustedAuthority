    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    seal_bytes_args_t* pargs_in = (seal_bytes_args_t*)input_buffer;
    seal_bytes_args_t* pargs_out = (seal_bytes_args_t*)output_buffer;
    ...
    /* Set in and in-out pointers. */
    if (pargs_in->data)
        OE_SET_IN_POINTER(data, ((size_t)pargs_in->data_size * sizeof(uint8_t)), uint8_t*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->out)
        OE_SET_OUT_POINTER(out, sizeof(uint8_t*), uint8_t**);
    if (pargs_in->out_size)
        OE_SET_OUT_POINTER(out_size, sizeof(size_t), size_t*);
...
static void ecall_unseal_bytes(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    unseal_bytes_args_t* pargs_in = (unseal_bytes_args_t*)input_buffer;
    unseal_bytes_args_t* pargs_out = (unseal_bytes_args_t*)output_buffer;
    ...
    /* Call user function. */
    pargs_out->_retval = unseal_bytes(
        pargs_in->data,
        pargs_in->data_size,
        pargs_in->out,
        pargs_in->out_size);
...
static void ecall_retrieve_private_key(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    retrieve_private_key_args_t* pargs_in = (retrieve_private_key_args_t*)input_buffer;
    retrieve_private_key_args_t* pargs_out = (retrieve_private_key_args_t*)output_buffer;
...
static void ecall_initialize_encryptor(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    /* Set in and in-out pointers. */
    if (pargs_in->key)
        OE_SET_IN_POINTER(key, sizeof(unsigned char), unsigned char*);
...
static void ecall_encrypt_block(
    uint8_t* input_buffer,
    size_t input_buffer_size,
    uint8_t* output_buffer,
    size_t output_buffer_size,
    size_t* output_bytes_written)
{
    ...
    if (pargs_in->input_buf)
        OE_SET_IN_POINTER(input_buf, ((size_t)pargs_in->size * sizeof(unsigned char)), unsigned char*);

    /* Set out and in-out pointers. */
    /* In-out parameters are copied to output buffer. */
    if (pargs_in->output_buf)
        OE_SET_OUT_POINTER(output_buf, sizeof(unsigned char*), unsigned char**);
    if (pargs_in->out_data_len)
        OE_SET_OUT_POINTER(out_data_len, sizeof(size_t), size_t*);
    ...
    size_t* output_bytes_written)
{
    ...
    /* Prepare parameters. */
    test_args_t* pargs_in = (test_args_t*)input_buffer;
    test_args_t* pargs_out = (test_args_t*)output_buffer;
...
oe_ecall_func_t __oe_ecalls_table[] = {
    ...
    (oe_ecall_func_t) ecall_seal_bytes,
    (oe_ecall_func_t) ecall_unseal_bytes,
    (oe_ecall_func_t) ecall_retrieve_private_key,
    (oe_ecall_func_t) ecall_initialize_encryptor,
    (oe_ecall_func_t) ecall_encrypt_block,
    (oe_ecall_func_t) ecall_close_encryptor,
    (oe_ecall_func_t) ecall_test,
