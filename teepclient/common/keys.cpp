...
int Encryptor::generate_password_key(
    const char* password,
    unsigned char* key,
...
int Encryptor::generate_encryption_key(
    unsigned char* key,
    unsigned int key_len)
{
    mbedtls_ctr_drbg_context ctr_drbg;
...
int Encryptor::cipher_encryption_key(
    bool encrypt,
...
//
int Encryptor::prepare_encryption_header(
...
int Encryptor::parse_encryption_header(
    encryption_header_t* header,
    string password)
{
    int ret = 0;
...
int Encryptor::process_encryption_header(
    bool encrypt,
    const char* password,
    size_t password_len,
    encryption_header_t* header)
